...
export function AgentSubagentCard({ message }: { message: AgentChatDisplayMessage }) {
  return (
    <article className="rounded-lg border border-hairline bg-canvas p-3">
      <div className="mb-1 text-[12px] font-semibold uppercase text-muted-strong">subagent</div>
